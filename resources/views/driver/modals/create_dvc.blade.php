<div class="modal fade" id="exampleModal" role="dialog" style="background-color:rgb(0 0 0 / 0%) !important;">
        ...
        <div class="modal-content model-content-custom">
            ...
            <div class="modal-body " style="background-color:rgb(0 0 0 / 0%) !important;">
                {{-- <div id="error-display"><span class="error">Please fill all mandotory fileds</span></div> --}}
                    <div class="">
                        <form method="post" action="{{route('store_dvc',['id'=>$driver->id])}}">
                            @csrf
                        ...
                        <div class="px-4 py-2 row">
                            <select  class="form-control" name="vehicle_category_id">
                        ...
                        <div class="row">
                            <div class="form-group" style="display:inline-flex;width:-webkit-fill-available;">
                                <label class="col-md-6 checkbox-inline" for="hourly_miles">
                                    <input type="checkbox" name="payout_calculation" class="hourly_miles" value="0">
                                    Hourly + Milage
                                </label>
                                <label class="col-md-6 checkbox-inline" for="default_payout_percentage">
                                    <input type="checkbox" name="payout_calculation" class="default_payout_percentage" value="1">
                                    Percentage
                                </label>
                            </div>
                        </div>
