@foreach ($customers as $customer)
  <div class="row p-4 customer_block record_block" id="customer_" >
    <div class="col-md-12 back-white border-radius-10">
      ...
      <div class="row px-3 py-2">
        <div class="col-md-6 py-2"><span style="line-height:100%; vertical-align:middle;">{{$customer->home_address}}</span></div>
        <div class="col-md-1">
        ...
        <div class="col-md-1">
          <a href="{{route('passengers',['id'=>$customer->id])}}">
              <div style="color:white;" id="customer_edit"><i class="fa fa-users color-sky pr-3 font140 py-1 minwidth50"></i></div>
          </a>
        </div>
        <div class="col-md-4">
